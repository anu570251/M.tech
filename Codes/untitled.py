...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_1.set_update_time(10)
        ...
        self.epy_block_1 = epy_block_1.blk(N=500, fs=1000000.0)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 250)
        ...
        self.connect((self.blocks_delay_0, 0), (self.epy_block_1, 1))
        ...
        self.connect((self.epy_block_1, 1), (self.qtgui_number_sink_0, 0))
