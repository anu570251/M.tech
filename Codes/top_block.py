...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.blk(N=1024)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'D:\\Passive-Radar\\Autocorr_Signal Generator.dat', False, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_delay_0, 0), (self.epy_block_0, 1))
